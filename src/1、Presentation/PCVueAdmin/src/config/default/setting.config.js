...
module.exports = {
  ...
  systemName: '风风停车场管理系统',         //系统名称
  copyright: '2021 风风科技',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://park.slickfeng.com', name: '演示'},
    {link: 'https://github.com/slickfeng/ffpark', icon: 'github'},
    {link: 'https://ant.design', name: 'Design by Ant Design'}
  ],
}
